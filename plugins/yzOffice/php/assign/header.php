...
<style type="text/css">
	...
	div.openSide .side-pager {
		...
		background: #eee;padding: 0 1em;margin-top: 4px;border-radius: 18px;
	}
	div#next, div#prev{
	...
	div.navbar-inverse .navbar-inner {
        ...
        background: #eee linear-gradient(to bottom, #fff, #eee) repeat-x;
    }
	div.navbar-inverse .nav>li>a {color: #666;text-shadow: none;}
	div.navbar-inverse .brand{color: #666;text-shadow: none;width:40%;margin-left:0;}
	div.changePage{color:#888;}

	div.navbar .nav{position: static;}
	.nav.word-tab-title .dropdown.word-tab-title-li{position:absolute;left:0;}
